...
const questions = [
    {
        q: 'Which football team has won the most FA Cup trophies?',
    ...
    {
        q: 'Which football player has the most assists in football history?',
    ...
    {
        q: 'Who has been given the most red cards since the year 2000?',
